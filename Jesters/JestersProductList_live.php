...
<?php
	...
	function processResults($xmlNodeList)
	{
		...
		echo "Applying insert/updates to table jps_smiffys_product" . "<br />";
		...
		while(1==1)
		{
			...
			if($query && !$newProduct)
			{
				...
				{									
					...
					{				
						...
						{
							printf("Difference found, product code %s, field name %s, XML field is %f DB field is %f",$productCode,$XMLfieldNames[$XMLFieldCount],(float)$XMLfields[$XMLFieldCount],(float)$row[$XMLFieldCount]); 
							echo "<br />";
					...
					{	
						...
						{
							printf("Difference found, product code %s, field name %s, XML field is %u DB field is %u",$productCode,$XMLfieldNames[$XMLFieldCount],(int)$XMLfields[$XMLFieldCount],(int)$row[$XMLFieldCount]); 
							echo "<br />";
					...
					{					
						...
						{
							echo "Difference found, product code is " . $productCode . " Field Name " . $XMLfieldNames[$XMLFieldCount] . " XML field is " . $XMLfields[$XMLFieldCount] . " DB field is " . $row[$XMLFieldCount] . "<br />";
					...
					{
						echo "Field Name" . $XMLfieldNames[$XMLFieldCount] . " Field Type " . $XMLfieldTypes[$XMLFieldCount] . " unknown at index " . $XMLFieldCount;
					}
			...
			if($same == FALSE)
			{
				...
				{
					echo "Updating Table jps_smiffys_product, Product Code: " . $productCode . "<br />";
				}
			}
			...
			/* if($i > 4000)		// TEMP for testing purposes!
			{
				break;
			}*/
		}
		
		echo "Completed insert/updates to table jps_smiffys_product" . "<br />";
